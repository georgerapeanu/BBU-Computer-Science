...
class StudentsServiceTests(unittest.TestCase):
    def setUp(self):
        self.students_service = StudentsService(GeneralRepository(Student), UndoRepository())
...
class DisciplinesServiceTests(unittest.TestCase):
    def setUp(self):
        self.disciplines_service = DisciplinesService(GeneralRepository(Discipline), UndoRepository())
