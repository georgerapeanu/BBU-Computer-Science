...
class GradesService:
    ...
    def __get_free_id(self):
        tmp = sorted(self.__grade_repository.list(), key=lambda x: x.id)
    ...
    def delete_student(self, student_id):
        ...
        if student is None:
            raise GradesServiceException("student with specified id doesn't exist")
        grades = list(filter(lambda x: x.student_id == student_id, self.__grade_repository.list()))
    ...
    def delete_discipline(self, discipline_id):
        ...
        if discipline is None:
            raise GradesServiceException("discipline with specified id doesn't exist")
        grades = list(filter(lambda x: x.discipline_id == discipline_id, self.__grade_repository.list()))
