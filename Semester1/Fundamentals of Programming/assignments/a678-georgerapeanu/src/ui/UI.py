...
class UI:
    ...
    def add_some_entities(self):
        self.__students_service.add_student(1, "AAA")
        self.__students_service.add_student(2, "BBB")
        self.__students_service.add_student(4, "CCC")
        self.__students_service.add_student(3, "DDD")
        self.__students_service.add_student(6, "ok")

        self.__disciplines_service.add_discipline(1, "FP")
        self.__disciplines_service.add_discipline(3, "ASC")
        self.__disciplines_service.add_discipline(2, "Algebra")
        self.__disciplines_service.add_discipline(5, "Analiza")
        self.__disciplines_service.add_discipline(4, "nush")

        self.__grades_service.add_grade(1, 1, 5)
        self.__grades_service.add_grade(3, 2, 1)
        self.__grades_service.add_grade(4, 5, 4)
        self.__grades_service.add_grade(6, 1, 10)
        self.__grades_service.add_grade(2, 3, 7)
        self.__grades_service.add_grade(3, 4, 7)
        self.__grades_service.add_grade(6, 4, 9)
        self.__grades_service.add_grade(4, 1, 10)
        self.__grades_service.add_grade(1, 1, 5)
        self.__grades_service.add_grade(1, 2, 10)
        self.__undo_service.clear()

    def run(self):
        self.add_some_entities()
        self.print_help_prompt()
        while True:
