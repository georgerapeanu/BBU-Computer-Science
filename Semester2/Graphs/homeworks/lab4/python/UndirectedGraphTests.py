from UndirectedGraph import UndirectedGraph, read_graph, write_graph, random_graph, get_connected_components, get_minimum_spanning_tree
import unittest
...
class UndirectedGraphTests(unittest.TestCase):
    ...
    def test_get_MST(self):
        ...
        self.graph.add_vertex("5")
        self.graph.add_edge("4", "5", 20)
        self.graph.add_edge("1", "4", 10)
        self.assertEqual(get_minimum_spanning_tree(self.graph), UndirectedGraph(["1", "2", "3", "4", "5"],
                                                                                [
                                                                                    ("1", "3", 3),
                                                                                    ("1", "4", 10),
                                                                                    ("2", "1", 10),
