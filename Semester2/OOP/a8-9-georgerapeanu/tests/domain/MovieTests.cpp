...
TEST(MovieTests, MovieValidatorTest1){
    ASSERT_THROW(Movie("", "romance", 1997, 97, "https://www.youtube.com/watch?v=cIJ8ma0kKtY"), DomainException);
    ASSERT_THROW(Movie("titanic", "", 1997, 97, "https://www.youtube.com/watch?v=cIJ8ma0kKtY"), DomainException);
    ASSERT_THROW(Movie("titanic", "romance", -1, 97, "https://www.youtube.com/watch?v=cIJ8ma0kKtY"), DomainException);
    ASSERT_THROW(Movie("titanic", "romance", 1997, -1, "https://www.youtube.com/watch?v=cIJ8ma0kKtY"), DomainException);
    ASSERT_THROW(Movie("titanic", "romance", 1997, 97, ""), DomainException);
    ASSERT_NO_THROW(Movie("titanic", "romance", 1997, 97, "https://www.youtube.com/watch?v=cIJ8ma0kKtY"));
};

TEST(MovieTests, MovieStreamTest){
    Movie first("titanic", "romance", 1997, 97, "https://www.youtube.com/watch?v=cIJ8ma0kKtY");
    std::stringstream f;
    f << first;
    Movie second;
