/*!
 * @file HTMLWatchlist.h this is a file that shows the model for a CSVWatchlist
 */
...
#ifndef A8_9_GEORGERAPEANU_HTMLWATCHLIST_H
#define A8_9_GEORGERAPEANU_HTMLWATCHLIST_H
#include "AbstractWatchlist.h"
#include <vector>
#include <string>

template<class T>
class HTMLWatchlist: public AbstractWatchlist<T>{
...
public:
     ...
     */
    HTMLWatchlist(const std::string &file_path);
...
#endif //A8_9_GEORGERAPEANU_HTMLWATCHLIST_H
