...
public:
     ...
     */
    MovieController(AbstractRepository<Movie> &repository, AbstractWatchlist<Movie> &watchlist, UndoActionsStack &undo_stack);
    /*!
    ...
    /*!
     * @brief this function undoes the last REST operation
     * @throws UndoException if no further undo is possible
     */
    void undo();

    /*!
     * @brief this function redoes the last REST operation
     * @throws UndoException if no further redo is possible
     */
    void redo();
};
