...
class UI{
    ...
    DynamicVector<std::string> split_command(const std::string &s);
     ...
     */
    void display_help(const DynamicVector<std::string> &help)const;
...
public:
     ...
     */
    UI(const MovieController& controller);
