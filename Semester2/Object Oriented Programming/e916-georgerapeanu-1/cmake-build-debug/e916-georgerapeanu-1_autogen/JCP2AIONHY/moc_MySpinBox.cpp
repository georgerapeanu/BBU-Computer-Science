...
#include "../../../include/ui/MySpinBox.h"
...
QT_MOC_LITERAL(1, 10, 15), // "counter_changed"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "question_id"
QT_MOC_LITERAL(4, 39, 5) // "delta"

    },
    "MySpinBox\0counter_changed\0\0question_id\0"
    "delta"
};
...
void MySpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->counter_changed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MySpinBox::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySpinBox::counter_changed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MySpinBox::counter_changed(int _t1, int _t2)
{
