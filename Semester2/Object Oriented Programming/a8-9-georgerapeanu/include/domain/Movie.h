...
class Movie{
    ...
    /*!
     * @brief istream insertion operator
     * @param in the input stream
     * @param c the movie
     * @return the input stream
     */
    friend std::istream &operator>> (std::istream &in, Movie& c);
    /*!
     * @brief ostream extraction operator
     * @param out
     * @param c
     * @return
     */
    friend std::ostream &operator<<(std::ostream &out, Movie c);
};
